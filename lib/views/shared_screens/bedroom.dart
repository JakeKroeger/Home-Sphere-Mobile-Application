...
class _bedroomPageState extends State<bedroomPage> {
  ...
  DatabaseReference ref = FirebaseDatabase.instance.ref("Bedroom");
    ...
    ref.onValue.listen((event) {
      if (event.snapshot.value != null) {
        setState(() {
          ...
          isLightOn = snapshotValue?['BedroomLights'];
          isFanOn = snapshotValue?['Fan'];
        });
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Container(
        ...
        Text(
          'Your Bedroom is connected                         with the following devices:',
          style: TextStyle(
            color: Colors.white,
