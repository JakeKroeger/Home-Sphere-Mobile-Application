...
class _kitchenPageState extends State<kitchenPage> {
  ...
  bool gasAlert = false;
  DatabaseReference ref = FirebaseDatabase.instance.ref("Kitchen");
  ...
  void initState() {
    ...
    ref.onValue.listen((event) {
      ...
      setState(() {
        ...
        isLightOn = snapshotValue?['KitchenLights'];        
      });
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Container(
        ...
        Text(
          'Your Kitchen is connected                         with the following devices:',
          style: TextStyle(
            color: Colors.white,
